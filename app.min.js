...
function getWeather(settings) {
    return new Promise(function (resolve, reject) {
        ...
        logger.info('url: ' + url);
        // https://query.yahooapis.com/v1/public/yql?q=select%20item.condition%20from%20weather.forecast%20where%20woeid%20in%20(select%20woeid%20from%20geo.places(1)%20where%20text=%22Trois-Rivieres,%20QC%22)%20and%20u=%27c%27&format=json
        // http://api.openweathermap.org/data/2.5/weather?q=Trois-Rivieres,%20QC&units=metric&appid=<your_api_key>
...
function getStreamText(settings, body) {
    ...
    return convertedIcon + temp + '°' + settings.Scale.name;
}
